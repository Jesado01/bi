...
├── src/main/java/com/bank/paymentorder/
│   ├── PaymentOrderServiceApplication.java
│   ├── infrastructure/
│   │   ├── web/
│   │   │   ├── controller/
...
│   │   │   │   │   ├── PartyReferenceRequest.java
│   │   │   │   │   ├── PartyIdentificationRequest.java
│   │   │   │   │   └── EstablishmentDirectoryReferenceRequest.java
│   │   │   │   └── response/
│   │   │   │       ├── RetrieveOrderConfirmationResponse.java
│   │   │   │       ├── OrderConfirmationResponse.java
│   │   │   │       ├── ServiceDirectoryEntryResponse.java
│   │   │   │       ├── BrandDirectoryEntryResponse.java
...
│   │   │   │   └── ServiceDirectoryRepository.java
│   │   │   ├── entity/
│   │   │   │   ├── OrderConfirmationEntity.java
│   │   │   │   ├── ServiceDirectoryEntity.java
│   │   │   │   └── BrandDirectoryEntity.java
│   │   │   └── adapter/
│   │   │       └── OrderConfirmationRepositoryAdapter.java
│   │   └── exception/
│   │       ├── GlobalExceptionHandler.java
│   │       └── PaymentOrderException.java
│   ├── application/
│   │   ├── service/
│   │   │   └── OrderConfirmationApplicationService.java
│   │   ├── usecase/
│   │   │   └── RetrieveOrderConfirmationUseCase.java
│   │   ├── port/
│   │   │   ├── in/
│   │   │   │   └── RetrieveOrderConfirmationPort.java
│   │   │   └── out/
│   │   │       └── OrderConfirmationRepositoryPort.java
│   │   └── mapper/
...
│       │   ├── ServiceDirectoryEntry.java
│       │   └── BrandDirectoryEntry.java
│       ├── valueobject/
...
│       │   └── ServiceCode.java
│       ├── service/
│       │   └── OrderConfirmationDomainService.java
│       └── exception/
│           ├── OrderConfirmationNotFoundException.java
│           └── InvalidPartyIdentificationException.java
├── src/main/resources/
│   ├── application.yml
│   ├── application-dev.yml
│   └── application-prod.yml
├── src/test/java/com/bank/paymentorder/
│   ├── infrastructure/web/controller/
│   │   └── OrderConfirmationControllerTest.java
│   ├── application/usecase/
│   │   └── RetrieveOrderConfirmationUseCaseTest.java
│   └── domain/service/
│       └── OrderConfirmationDomainServiceTest.java
└── pom.xml
```
